...
export const VetSignatureModal: React.FC<VetSignatureModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 overflow-y-auto animate-in fade-in duration-200">
      <div className="bg-white border border-slate-200 rounded-3xl p-5 sm:p-7 max-w-2xl w-full shadow-2xl shadow-slate-900/20 text-slate-800 my-8">
        {/* Cabeçalho */}
        <div className="flex items-center justify-between pb-4 border-b border-slate-100">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-cyan-500 to-teal-600 text-white flex items-center justify-center shadow-md shadow-teal-500/20">
              <PenTool className="w-5 h-5" />
            </div>
            <div>
              <h2 className="text-base sm:text-lg font-black text-slate-900 leading-tight flex items-center gap-2">
                <span>Minha Assinatura &amp; CRMV</span>
                <span className="text-[10px] px-2 py-0.5 rounded-full bg-teal-50 text-teal-700 font-bold border border-teal-200">
                  CFMV / Laudo Oficial
                </span>
              </h2>
              <p className="text-xs text-slate-500 mt-0.5">
                Configure seus dados profissionais e carimbo digitalizado para emissão de laudos.
              </p>
            </div>
          </div>
          <button
        ...
        {errorMessage && (
          <div className="mt-4 p-3 bg-rose-50 border border-rose-200 rounded-xl text-rose-800 text-xs flex items-center gap-2 animate-in fade-in">
        ...
        {successMessage && (
          <div className="mt-4 p-3 bg-emerald-50 border border-emerald-200 rounded-xl text-emerald-800 text-xs font-bold flex items-center gap-2 animate-in fade-in">
        ...
        <form onSubmit={handleSave} className="mt-5 space-y-5">
          ...
          <div className="space-y-3">
            <div className="text-xs font-bold uppercase tracking-wider text-slate-700 flex items-center gap-1.5">
              ...
              <span>Dados Cadastrais do Médico(a) Veterinário(a)</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="sm:col-span-2">
                <label className="block text-xs font-semibold text-slate-700 mb-1">
                  Nome Completo (como aparecerá no carimbo do laudo) *
                </label>
                <input
                  type="text"
                  required
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 text-xs focus:border-teal-500 focus:bg-white focus:outline-none transition shadow-2xs font-medium"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 text-xs focus:border-teal-500 focus:bg-white focus:outline-none transition shadow-2xs font-mono font-semibold"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 text-xs focus:border-teal-500 focus:bg-white focus:outline-none transition shadow-2xs font-semibold cursor-pointer"
                >
                  {UF_LIST.map(state => (
              ...
              <div className="sm:col-span-2">
                <div className="flex items-center justify-between mb-1">
                  <label className="block text-xs font-semibold text-slate-700">
                    Título / Especialidade no Laudo *
                  </label>
                  <span className="text-[10px] text-slate-400">
                    Aparece abaixo do CRMV
                  </span>
                </div>
                <input
                  type="text"
                ...
                <div className="flex flex-wrap gap-1.5 mt-2">
                  {SPECIALTY_SUGGESTIONS.slice(0, 4).map(sug => (
                    <button
                      key={sug}
                      type="button"
              ...
              <div className="sm:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 text-xs focus:border-teal-500 focus:bg-white focus:outline-none transition shadow-2xs"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="space-y-3 pt-3 border-t border-slate-100">
            <div className="flex items-center justify-between">
              <label className="text-xs font-bold uppercase tracking-wider text-slate-700 flex items-center gap-1.5">
                ...
                <span>Assinatura Digital &amp; Carimbo</span>
              </label>
              ...
              <div className="space-y-2">
                ...
                {signatureImage ? (
                  <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200 flex flex-col sm:flex-row items-center gap-4">
                    <div className="h-16 w-48 p-2 bg-white rounded-xl border border-slate-200 flex items-center justify-center shadow-2xs shrink-0">
                    ...
                    <div className="space-y-1 flex-1 text-center sm:text-left">
                      ...
                      <p className="text-[11px] text-slate-500">
                        Esta imagem será aplicada no rodapé dos laudos com o seu CRMV e especialidade.
                      </p>
                      <button
                        type="button"
                  ...
                  >
                    {isUploading ? (
                      <div className="flex flex-col items-center justify-center gap-2 text-teal-700 py-2">
                        <Loader2 className="w-7 h-7 animate-spin" />
                        <span className="text-xs font-bold">Processando upload...</span>
                      </div>
                    ) : (
                      <div className="space-y-2">
                        <div className="w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center mx-auto text-teal-600 group-hover:scale-110 transition-transform shadow-2xs">
                          <UploadCloud className="w-5 h-5" />
                        </div>
                        <div>
                          <span className="text-xs font-bold text-slate-800 block">
                            Clique para carregar a foto ou arquivo da sua assinatura
                          </span>
                          <span className="text-[11px] text-slate-500">
                            Recomendado: PNG com fundo transparente ou foto nítida em papel branco
                          </span>
                        </div>
                      </div>
                    )}
            ...
            {activeTab === 'draw' && (
              <div className="space-y-2.5">
                <div className="relative border-2 border-slate-300 rounded-2xl overflow-hidden bg-white shadow-inner">
                  <canvas
                    ref={canvasRef}
                    width={560}
                    height={180}
                    ...
                    className="w-full h-[140px] sm:h-[160px] cursor-crosshair touch-none"
                  />
                  <div className="absolute bottom-2 left-3 pointer-events-none text-[10px] text-slate-400 font-sans italic">
                    ✍️ Assine aqui com mouse, caneta ou tela touch
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-xl bg-teal-600 hover:bg-teal-700 text-white text-xs font-bold shadow-sm transition disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                  >
                    {isUploading ? (
                      <>
                      ...
                      <>
                        ...
                        <span>Usar Este Traço como Assinatura</span>
                      </>
                    )}
                  </button>
                </div>
          ...
          <div className="p-4 rounded-2xl bg-gradient-to-br from-teal-50/70 via-slate-50 to-cyan-50/70 border border-slate-200/90 space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-[10px] uppercase font-bold text-slate-500 tracking-wider flex items-center gap-1">
                <Sparkles className="w-3 h-3 text-teal-600" />
                <span>Pré-visualização em Tempo Real (Rodapé do Laudo Oficial)</span>
              </span>
              <span className="text-[9px] font-mono text-teal-700 font-bold bg-white px-2 py-0.5 rounded-md border border-teal-200">
                Padrão CFMV
              </span>
            </div>

            <div className="bg-white rounded-2xl p-4 border border-slate-200/90 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-5">
              {/* Autenticação simulada */}
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-slate-50 border border-slate-200 rounded-xl flex items-center justify-center text-slate-700 shadow-2xs">
              ...
              {/* Carimbo / Assinatura */}
              <div className="text-center sm:text-right border-t sm:border-t-0 sm:border-l border-slate-200 pt-3 sm:pt-0 sm:pl-5 w-full sm:w-auto">
                {signatureImage ? (
                  ...
                  <div className="font-serif italic text-base text-slate-700 font-semibold mb-0.5">
          ...
          <div className="flex items-center justify-end gap-2.5 pt-3 border-t border-slate-100">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-teal-500 to-cyan-600 hover:from-teal-600 hover:to-cyan-700 text-white rounded-xl text-xs font-bold shadow-md shadow-teal-500/20 transition active:scale-95 cursor-pointer disabled:opacity-50"
            >
              {isSaving ? (
                <>
                ...
                <>
                  ...
                  <span>Salvar Assinatura &amp; CRMV</span>
                </>
              )}
            </button>
          </div>
